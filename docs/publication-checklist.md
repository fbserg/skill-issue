...
## Code quality
- [ ] `python3 scripts/check-install.py` passes and covers every shipped Claude skill symlink and all three delegate agent symlinks (`explore-mid.md`, `opus-worker.md`, `worker.md` under `~/.claude/agents/`)
