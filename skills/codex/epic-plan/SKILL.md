...
- For a new topic, derive a stable kebab-case slug. Pre-GO research may use `/tmp/epic-plan/<slug>/`; delete it after successful materialization.
...
10. Present the contract, upheld blockers and resolutions, advisories, child DAG, and exact handoff waves. Create nothing until the user says `GO`.
