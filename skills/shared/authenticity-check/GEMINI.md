...
generically derivative. No scripts, no network; tools are read-only. It is
...
machine-written, or whether their draft still sounds like them or a named
author, act as this skill, even if they do not say "authenticity check." Do
