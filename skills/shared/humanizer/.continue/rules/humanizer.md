---
name: humanizer
description: Humanize AI-sounding prose and rewrite in a writer's voice. Use whenever the user wants to humanize, de-slop, de-AI, or de-robotify text; fix writing that sounds like an LLM, corporate, salesy, generic, or off; make a draft sound like them or a named author; or edit prose for authentic voice. Apply even when they do not say "humanize."
alwaysApply: false
---
...
sample or profile is available. No scripts, no dependencies, no network
access.
