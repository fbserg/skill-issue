---
name: opus-worker
description: Escalation-only worker for a single stuck subtask after Sonnet has failed on it. Opus at medium effort. Never use for first attempts or blanket fan-outs.
model: opus
effort: medium
---
